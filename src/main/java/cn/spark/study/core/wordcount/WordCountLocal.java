...
public class WordCountLocal {
	...
	public static void main(String[] args) {
		...
		SparkConf conf = new SparkConf()
				.setAppName("WordCountLocal")  // sparkUI 显示的命字
				.setMaster("local");  
		...
		JavaPairRDD<String, Integer> pairs =
				wordList.filter(word->!word.isEmpty())
		...
		wordCounts.foreach(wordCount->System.out.println(wordCount._1 + " appeared " + wordCount._2 + " times."));
